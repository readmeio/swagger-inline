  ...
  describe('#expandParam', () => {
    it('parses params properly', () => {
      const test = {
        ...
        '(body) test {ref:Test} this is a description': {
          in: 'body',
          name: 'test',
          schema: { $ref: '#/definitions/Test' },
          description: 'this is a description',
        },
        '(body) test {ref:local.json#/definitions/pet} this is a description': {
          in: 'body',
          name: 'test',
          schema: { $ref: 'local.json#/definitions/pet' },
          description: 'this is a description',
        },
    ...
    describe('OpenAPI 3.0', () => {
      it('parses params properly', () => {
        const test = {
          ...
          '(body) test {ref:schemas/Test} this is a description': {
            in: 'body',
            name: 'test',
            schema: { $ref: '#/components/schemas/Test' },
            description: 'this is a description',
          },
          '(body) test {ref:local.json#/components/schemas/Pet} this is a description': {
            in: 'body',
            name: 'test',
            schema: { $ref: 'local.json#/components/schemas/Pet' },
            description: 'this is a description',
          },
          'test {Boolean:hi} this is a description': false,
          '(body) test this is a description': false,
